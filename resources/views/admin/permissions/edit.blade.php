            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="flex flex-wrap py-2 items-center justify-evenly">
                    <div class="sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/2 h-12 text-center align-baseline">
                        <input class="bg-blue-500 hover:bg-white hover:text-black text-white  py-2 px-4 rounded" type="submit" value="Update" />
                    </div>
                    <div class="sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/2 h-12 text-center align-baseline">
                        <a class="inline-block align-baseline text-gray-400 hover:text-white" href="/roles">
                            Cancel
                        </a>
                    </div>
                </div>
