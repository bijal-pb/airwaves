<div class="pagination dark:bg-gray-800 flex rounded border border-gray-300 overflow-hidden divide-x divide-gray-300">
    <!-- Previous Page Link -->
    ...
    <div class="pagination divide-x divide-gray-300">
